...
umain(int argc, char **argv)
{
  ...
  80006c:	c3                   	ret    
		panic("spawn(faultio) failed: %e", r);
  80006d:	50                   	push   %eax
  80006e:	68 e6 29 80 00       	push   $0x8029e6
  800073:	6a 09                	push   $0x9
  800075:	68 00 2a 80 00       	push   $0x802a00
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800107:	56                   	push   %esi
  800108:	50                   	push   %eax
  800109:	68 20 2a 80 00       	push   $0x802a20
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80027a:	0f be 80 43 2a 80 00 	movsbl 0x802a43(%eax),%eax
  800281:	50                   	push   %eax
...
008002d1 <vprintfmt>:
{
  ...
  800411:	50                   	push   %eax
  800412:	68 5b 2a 80 00       	push   $0x802a5b
  800417:	53                   	push   %ebx
  800418:	56                   	push   %esi
  ...
  800439:	b8 54 2a 80 00       	mov    $0x802a54,%eax
