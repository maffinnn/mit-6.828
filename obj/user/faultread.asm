	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800203:	0f be 80 88 23 80 00 	movsbl 0x802388(%eax),%eax
  80020a:	50                   	push   %eax
...
0080025a <vprintfmt>:
{
  ...
  8002aa:	3e ff 24 85 c0 24 80 	notrack jmp *0x8024c0(,%eax,4)
  8002b1:	00 
  ...
  800377:	8b 14 85 20 26 80 00 	mov    0x802620(,%eax,4),%edx
  80037e:	85 d2                	test   %edx,%edx
  800380:	74 18                	je     80039a <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  800382:	52                   	push   %edx
  800383:	68 29 27 80 00       	push   $0x802729
  800388:	53                   	push   %ebx
  800389:	56                   	push   %esi
  ...
  80039a:	50                   	push   %eax
  80039b:	68 a0 23 80 00       	push   $0x8023a0
  8003a0:	53                   	push   %ebx
  8003a1:	56                   	push   %esi
  ...
  8003c2:	b8 99 23 80 00       	mov    $0x802399,%eax
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e58:	8b 04 95 fc 26 80 00 	mov    0x8026fc(,%edx,4),%eax
  ...
  800e6e:	51                   	push   %ecx
  800e6f:	50                   	push   %eax
  800e70:	68 80 26 80 00       	push   $0x802680
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8010dc:	53                   	push   %ebx
  8010dd:	50                   	push   %eax
  8010de:	68 c1 26 80 00       	push   $0x8026c1
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8011ad:	53                   	push   %ebx
  8011ae:	50                   	push   %eax
  8011af:	68 dd 26 80 00       	push   $0x8026dd
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80125d:	53                   	push   %ebx
  80125e:	50                   	push   %eax
  80125f:	68 a0 26 80 00       	push   $0x8026a0
...
0080147d <devfile_read>:
{
  ...
  8014d6:	c3                   	ret    
	assert(r <= n);
  8014d7:	68 10 27 80 00       	push   $0x802710
  8014dc:	68 17 27 80 00       	push   $0x802717
  8014e1:	68 8c 00 00 00       	push   $0x8c
  8014e6:	68 2c 27 80 00       	push   $0x80272c
  8014eb:	e8 79 0a 00 00       	call   801f69 <_panic>
	assert(r <= PGSIZE);
  8014f0:	68 37 27 80 00       	push   $0x802737
  8014f5:	68 17 27 80 00       	push   $0x802717
  8014fa:	68 8d 00 00 00       	push   $0x8d
  8014ff:	68 2c 27 80 00       	push   $0x80272c
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8015c0:	68 a3 27 80 00       	push   $0x8027a3
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  8019c7:	c3                   	ret    
		assert(r < 1600 && r <= len);
  8019c8:	68 af 27 80 00       	push   $0x8027af
  8019cd:	68 17 27 80 00       	push   $0x802717
  8019d2:	6a 62                	push   $0x62
  8019d4:	68 c4 27 80 00       	push   $0x8027c4
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801a29:	c3                   	ret    
	assert(size < 1600);
  801a2a:	68 d0 27 80 00       	push   $0x8027d0
  801a2f:	68 17 27 80 00       	push   $0x802717
  801a34:	6a 6d                	push   $0x6d
  801a36:	68 c4 27 80 00       	push   $0x8027c4
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801a8a:	68 dc 27 80 00       	push   $0x8027dc
  801a8f:	53                   	push   %ebx
...
00801aee <_pipeisclosed>:
{
  ...
  801b31:	50                   	push   %eax
  801b32:	53                   	push   %ebx
  801b33:	68 e3 27 80 00       	push   $0x8027e3
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801de8:	68 fb 27 80 00       	push   $0x8027fb
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801f89:	56                   	push   %esi
  801f8a:	50                   	push   %eax
  801f8b:	68 08 28 80 00       	push   $0x802808
  ...
  801f9c:	e8 61 e1 ff ff       	call   800102 <vcprintf>
	cprintf("\n");
  801fa1:	c7 04 24 7c 23 80 00 	movl   $0x80237c,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802065:	c3                   	ret    
			panic("ipc_send: %e\n", ret);
  802066:	50                   	push   %eax
  802067:	68 2b 28 80 00       	push   $0x80282b
  80206c:	6a 48                	push   $0x48
  80206e:	68 39 28 80 00       	push   $0x802839
