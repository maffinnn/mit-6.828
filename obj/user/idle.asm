...
umain(int argc, char **argv)
{
  ...
  80003a:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  80003d:	c7 05 00 30 80 00 60 	movl   $0x802360,0x803000
  800044:	23 80 00 
	...
	while (1) {
		sys_yield();
  800047:	e8 f6 00 00 00       	call   800142 <sys_yield>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8003f3:	8b 04 95 ec 23 80 00 	mov    0x8023ec(,%edx,4),%eax
  ...
  800409:	51                   	push   %ecx
  80040a:	50                   	push   %eax
  80040b:	68 70 23 80 00       	push   $0x802370
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800677:	53                   	push   %ebx
  800678:	50                   	push   %eax
  800679:	68 b1 23 80 00       	push   $0x8023b1
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800748:	53                   	push   %ebx
  800749:	50                   	push   %eax
  80074a:	68 cd 23 80 00       	push   $0x8023cd
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8007f8:	53                   	push   %ebx
  8007f9:	50                   	push   %eax
  8007fa:	68 90 23 80 00       	push   $0x802390
...
00800a18 <devfile_read>:
{
  ...
  800a71:	c3                   	ret    
	assert(r <= n);
  800a72:	68 00 24 80 00       	push   $0x802400
  800a77:	68 07 24 80 00       	push   $0x802407
  800a7c:	68 8c 00 00 00       	push   $0x8c
  800a81:	68 1c 24 80 00       	push   $0x80241c
  800a86:	e8 79 0a 00 00       	call   801504 <_panic>
	assert(r <= PGSIZE);
  800a8b:	68 27 24 80 00       	push   $0x802427
  800a90:	68 07 24 80 00       	push   $0x802407
  800a95:	68 8d 00 00 00       	push   $0x8d
  800a9a:	68 1c 24 80 00       	push   $0x80241c
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b5b:	68 93 24 80 00       	push   $0x802493
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  800f62:	c3                   	ret    
		assert(r < 1600 && r <= len);
  800f63:	68 9f 24 80 00       	push   $0x80249f
  800f68:	68 07 24 80 00       	push   $0x802407
  800f6d:	6a 62                	push   $0x62
  800f6f:	68 b4 24 80 00       	push   $0x8024b4
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  800fc4:	c3                   	ret    
	assert(size < 1600);
  800fc5:	68 c0 24 80 00       	push   $0x8024c0
  800fca:	68 07 24 80 00       	push   $0x802407
  800fcf:	6a 6d                	push   $0x6d
  800fd1:	68 b4 24 80 00       	push   $0x8024b4
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801025:	68 cc 24 80 00       	push   $0x8024cc
  80102a:	53                   	push   %ebx
...
00801089 <_pipeisclosed>:
{
  ...
  8010cc:	50                   	push   %eax
  8010cd:	53                   	push   %ebx
  8010ce:	68 d3 24 80 00       	push   $0x8024d3
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801383:	68 eb 24 80 00       	push   $0x8024eb
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801524:	56                   	push   %esi
  801525:	50                   	push   %eax
  801526:	68 f8 24 80 00       	push   $0x8024f8
  ...
  801537:	e8 5a 00 00 00       	call   801596 <vcprintf>
	cprintf("\n");
  80153c:	c7 04 24 e4 24 80 00 	movl   $0x8024e4,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801697:	0f be 80 1b 25 80 00 	movsbl 0x80251b(%eax),%eax
  80169e:	50                   	push   %eax
...
008016ee <vprintfmt>:
{
  ...
  801816:	52                   	push   %edx
  801817:	68 19 24 80 00       	push   $0x802419
  80181c:	53                   	push   %ebx
  80181d:	56                   	push   %esi
  ...
  80182e:	50                   	push   %eax
  80182f:	68 33 25 80 00       	push   $0x802533
  801834:	53                   	push   %ebx
  801835:	56                   	push   %esi
  ...
  801856:	b8 2c 25 80 00       	mov    $0x80252c,%eax
