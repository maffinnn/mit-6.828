...
trap_init(void)
{
	...
	// declare function来获取function pointer
...
trap(struct Trapframe *tf)
{
	...
	// the interrupt path.
	/*	
     * 如果上面setgate的第二个参数设置为1那么这里的assertion会fail（why）
	*/
